...
class TextureBufferCreator : public BufferCreatorBase<TextureBufferCreator>
{
public:
  TextureBufferCreator() = default;

  template<class TupleType>
  void create(TupleType bufferInfo, const std::vector<stbi_uc>& pixels, VkImage& image, VkDeviceMemory& imageMemory)
  {
    auto [texWidth, texHeight, bufferSize] = bufferInfo;
    ...
    memcpy(data, pixels.data(), (size_t)bufferSize);
